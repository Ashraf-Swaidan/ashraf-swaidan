...
- Suppliers: supplier table, COGS expense table, or supplier spend chart.
- Expenses: expense table, recurring templates, branch/payment context.
- Wallets: wallet cards, transactions, transfer modal, branch wallets, or loans.
...
- `papion-module-customers.png`
- `papion-module-suppliers.png`
- `papion-module-expenses.png`
- `papion-module-wallets.png`
- `papion-workflow-order.mp4`
- `papion-workflow-expense-wallet.mp4`
- `papion-workflow-customer.mp4`
- `papion-finance-control.mp4`
- `papion-responsive-sales-desktop.png`
- `papion-responsive-sales-tablet.png`
- `papion-responsive-sales-mobile.png`
