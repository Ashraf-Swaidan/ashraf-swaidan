...
export function DuwitPage() {
  ...
  useGSAP(
    () => {
      ...
      const heroInner = root.querySelector(".duwit-hero-inner")
      ...
      const blocks = gsap.utils.toArray<HTMLElement>(
        root.querySelectorAll(".duwit-story-block")
      )
      blocks.forEach((el) => {
        gsap.fromTo(
          el,
