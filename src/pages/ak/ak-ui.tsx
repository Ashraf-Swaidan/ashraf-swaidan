...
import { AK_BODY_FONT, AK_DISPLAY_FONT, AK_LOGO } from "./ak-data"

export function AkWordmark({ className = "" }: { className?: string }) {
  return (
...
export function AkEyebrow({ children }: { children: ReactNode }) {
  return (
    <p
...
export function AkStoryStep({ n, label }: { n: string; label: string }) {
  return (
    <p
