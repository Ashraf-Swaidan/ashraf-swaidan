...
export const DUWIT_VIDEO_POSTER = "/assets/lap-animation-assets/duwit-lap.jpg"
...
/** Add gen-1.png through gen-5.png under public/assets/duwit-page/duwit-screenshots/. */
export const DUWIT_SCREENSHOTS = [
  {
    key: "gen-1",
    src: "/assets/duwit-page/duwit-screenshots/gen-1.png",
    alt: "Duwit product — main view (desktop or web)",
  },
  {
    key: "gen-2",
    src: "/assets/duwit-page/duwit-screenshots/gen-2.png",
    alt: "Duwit product — planning or goal flow",
  },
  {
    key: "gen-3",
    src: "/assets/duwit-page/duwit-screenshots/gen-3.png",
    alt: "Duwit product — task or coaching surface",
  },
  {
    key: "gen-4",
    src: "/assets/duwit-page/duwit-screenshots/gen-4.png",
    alt: "Duwit product — execution detail",
  },
  {
    key: "gen-5",
    src: "/assets/duwit-page/duwit-screenshots/gen-5.png",
