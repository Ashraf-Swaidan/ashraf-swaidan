...
import { LUXIAN_BODY_FONT, LUXIAN_DISPLAY_FONT, LUXIAN_LOGO } from "./luxian-data"

export function LuxianWordmark({ className = "" }: { className?: string }) {
  return (
...
export function LuxianStoryTitle({
  as: Tag = "h2",
  children,
  className = "",
}: {
...
export function LuxianStoryStep({ n, label }: { n: string; label: string }) {
  return (
    <p
