...
export const TWODO_VIDEO_POSTER = "/assets/lap-animation-assets/twodo-lap.jpg"

/** Five captures under `public/assets/twodo-page/`. */
export const TWODO_SCREENSHOTS = [
  {
    key: "gen-1",
    src: "/assets/twodo-page/gen-1.png",
    alt: "Twodo app: all todos list with sidebar, search, and add task control",
  },
  {
    key: "gen-2",
    src: "/assets/twodo-page/gen-2.png",
    alt: "Twodo app: task list and inline actions",
  },
  {
    key: "gen-3",
    src: "/assets/twodo-page/gen-3.png",
    alt: "Twodo app: project or task detail view",
  },
  {
    key: "gen-4",
    src: "/assets/twodo-page/gen-4.png",
    alt: "Twodo app: tags or filters surface",
  },
  {
    key: "gen-5",
    src: "/assets/twodo-page/gen-5.png",
